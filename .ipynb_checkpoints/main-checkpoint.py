...
class FaceRecognitionSystem:
    def __init__(self):
        ...
        self.response = requests.get("http://192.168.1.16/cam-hi.jpg")
        self.image_camara = np.array(Image.open(BytesIO(response.content)))
        ...
        if self.success:
            ...
            if faceCurFrame:
                ...
                for encodeFace, faceLoc in zip(encodeCurFrame, faceCurFrame):
                    ...
                    if matches[matchIndex] and closest_distance < 0.67:                       
